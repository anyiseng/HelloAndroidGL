#ifndef HALIDE__halide_gl_filter_h
#define HALIDE__halide_gl_filter_h
#include <stdint.h>
...
int halide_gl_filter(float _p0, struct halide_buffer_t *_f0_buffer);

HALIDE_FUNCTION_ATTRS
int halide_gl_filter_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *halide_gl_filter_metadata();
